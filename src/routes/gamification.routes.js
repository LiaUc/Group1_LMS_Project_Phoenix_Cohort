...
router.get(
  ...
  gamificationController.getTrendingAchievements,
);
router.get(
  "/achievements/:achievementId",
  gamificationController.getAchievementDetails,
);
...
router.get(
  ...
  protect,
  gamificationController.getLeaderboardPosition,
);
router.get(
  "/my/leaderboard/near",
  protect,
  gamificationController.getLeaderboardNearUser,
);
